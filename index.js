...
const init = async ({console}) => {
    ...
    const socket = io(_.get(process.env, 'SOCKET_SERVER', 'ws://portal3.nl:7474'), { transports: ['websocket'], reconnect: true, query: { hub_serial: await Device.GetSerialNumber(), model: await Device.getModel() }, maxReconnectionAttempts: Infinity })
